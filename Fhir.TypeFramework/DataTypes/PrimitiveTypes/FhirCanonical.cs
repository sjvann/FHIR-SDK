...
public class FhirCanonical : PrimitiveTypeBase<string>
{
    ...
    public static implicit operator FhirCanonical(string? value) => new(value);
    public static implicit operator string?(FhirCanonical fhirValue) => fhirValue?.Value;
    ...
    public override IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        {
            yield return new ValidationResult("Canonical must be a valid absolute URI");
        }
    }
} 