...
/// </remarks>
public class Duration : UnifiedComplexTypeBase<Duration>
{
    /// <summary>
    /// 數值（隱含精度）
    ...
    protected override void CopyFieldsTo(Duration target)
    {
    ...
    protected override bool FieldsAreExactly(Duration other)
    {
