...
/// </remarks>
public class Distance : UnifiedComplexTypeBase<Distance>
{
    /// <summary>
    /// 數值（隱含精度）
    ...
    protected override void CopyFieldsTo(Distance target)
    {
    ...
    protected override bool FieldsAreExactly(Distance other)
    {
