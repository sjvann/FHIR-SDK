...
namespace FhirCore.R4.Resources
{
    ...
    /// <example>
    /// <code>
    /// var researchdefinition = new ResearchDefinition("researchdefinition-001");
    /// // 設定資源屬性...
    /// </code>
    /// </example>
    /// </summary>
    /// <remarks>
    /// <para>
    /// R4 版本的 ResearchDefinition 資源具有以下特點：
    /// - 增強的資料結構
    /// - 改進的驗證規則
    /// - 更好的互操作性
    /// </para>
    /// </remarks>
    public class ResearchDefinition : ResourceBase<R4Version>
    {
        ...
        public ResearchDefinition(string id)
        {
            Id = id;
        }
        ...
        {
            return $"ResearchDefinition(Id: {Id})";
        }
    }
}
