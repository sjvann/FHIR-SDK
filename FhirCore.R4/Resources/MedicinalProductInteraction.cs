...
{
    /// <summary>
    /// FHIR R4 MedicinalProductInteraction 資源
    /// 
    /// <para>
    ...
    /// <example>
    /// <code>
    /// var medicinalproductinteraction = new MedicinalProductInteraction("medicinalproductinteraction-001");
    /// // 設定資源屬性...
    /// </code>
    /// </example>
    /// </summary>
    /// <remarks>
    /// <para>
    /// R4 版本的 MedicinalProductInteraction 資源具有以下特點：
    /// - 增強的資料結構
    /// - 改進的驗證規則
    /// - 更好的互操作性
    /// </para>
    /// </remarks>
    public class MedicinalProductInteraction : ResourceBase<R4Version>
    {
        ...
        private List<BackboneElement>? _interactant;
        ...
        /// </para>
        /// </remarks>
        public List<BackboneElement>? interactant
        {
            get => _interactant;
            set
            {
        ...
        /// <summary>
        /// 建立新的 MedicinalProductInteraction 資源實例
        /// </summary>
        ...
        public MedicinalProductInteraction(string id)
        {
            Id = id;
        }
        ...
        {
            return $"MedicinalProductInteraction(Id: {Id})";
        }
    }
}
