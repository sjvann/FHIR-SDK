...
{
    /// <summary>
    /// FHIR R4 EffectEvidenceSynthesis 資源
    /// 
    /// <para>
    ...
    /// <example>
    /// <code>
    /// var effectevidencesynthesis = new EffectEvidenceSynthesis("effectevidencesynthesis-001");
    /// // 設定資源屬性...
    /// </code>
    /// </example>
    /// </summary>
    /// <remarks>
    /// <para>
    /// R4 版本的 EffectEvidenceSynthesis 資源具有以下特點：
    /// - 增強的資料結構
    /// - 改進的驗證規則
    /// - 更好的互操作性
    /// </para>
    /// </remarks>
    public class EffectEvidenceSynthesis : ResourceBase<R4Version>
    {
        ...
        private List<BackboneElement>? _effectestimate;
        ...
        /// <remarks>
        /// <para>
        /// effectEstimate 的詳細描述。
        /// </para>
        /// </remarks>
        public List<BackboneElement>? effectEstimate
        {
            get => _effectestimate;
            set
            {
                _effectestimate = value;
                OnPropertyChanged(nameof(effectEstimate));
            }
        }
        ...
        private ReferenceType? _exposurealternative;
        ...
        /// <remarks>
        /// <para>
        /// exposureAlternative 的詳細描述。
        /// </para>
        /// </remarks>
        public ReferenceType? exposureAlternative
        {
            get => _exposurealternative;
            set
            {
                _exposurealternative = value;
                OnPropertyChanged(nameof(exposureAlternative));
            }
        }
        ...
        private List<BackboneElement>? _resultsbyexposure;
        ...
        /// <remarks>
        /// <para>
        /// resultsByExposure 的詳細描述。
        /// </para>
        /// </remarks>
        public List<BackboneElement>? resultsByExposure
        {
            get => _resultsbyexposure;
            set
            {
                _resultsbyexposure = value;
                OnPropertyChanged(nameof(resultsByExposure));
            }
        }
        ...
        /// 資源類型
        /// </summary>
        public override string ResourceType => "EffectEvidenceSynthesis";

        /// <summary>
        /// 建立新的 EffectEvidenceSynthesis 資源實例
        /// </summary>
        ...
        public EffectEvidenceSynthesis(string id)
        {
            Id = id;
        }
        ...
        {
            return $"EffectEvidenceSynthesis(Id: {Id})";
        }
    }
}
