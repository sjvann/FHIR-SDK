...
{
    /// <summary>
    /// FHIR R4 ResearchElementDefinition 資源
    /// 
    /// <para>
    ...
    /// <example>
    /// <code>
    /// var researchelementdefinition = new ResearchElementDefinition("researchelementdefinition-001");
    /// // 設定資源屬性...
    /// </code>
    /// </example>
    /// </summary>
    /// <remarks>
    /// <para>
    /// R4 版本的 ResearchElementDefinition 資源具有以下特點：
    /// - 增強的資料結構
    /// - 改進的驗證規則
    /// - 更好的互操作性
    /// </para>
    /// </remarks>
    public class ResearchElementDefinition : ResourceBase<R4Version>
    {
        ...
        private List<FhirString>? _comment;
        ...
        /// </para>
        /// </remarks>
        public List<FhirString>? comment
        {
            get => _comment;
            set
            {
        ...
        private FhirCode? _variabletype;
        ...
        /// <summary>
        /// 建立新的 ResearchElementDefinition 資源實例
        /// </summary>
        ...
        public ResearchElementDefinition(string id)
        {
            Id = id;
        }
        ...
        {
            return $"ResearchElementDefinition(Id: {Id})";
        }
    }
}
