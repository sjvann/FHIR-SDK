...
namespace FhirCore.R4.Resources
{
    ...
    /// <remarks>
    /// <para>
    /// R4 版本的 Evidence 資源具有以下特點：
    /// - 增強的資料結構
    /// - 改進的驗證規則
    /// - 更好的互操作性
    /// </para>
    /// </remarks>
    public class Evidence : ResourceBase<R4Version>
    {
        ...
        private ReferenceType? _exposurebackground;
        ...
        /// <remarks>
        /// <para>
        /// exposureBackground 的詳細描述。
        /// </para>
        /// </remarks>
        public ReferenceType? exposureBackground
        {
            get => _exposurebackground;
            set
            {
                _exposurebackground = value;
                OnPropertyChanged(nameof(exposureBackground));
            }
        }

        private List<ReferenceType>? _exposurevariant;
        ...
        /// <remarks>
        /// <para>
        /// exposureVariant 的詳細描述。
        /// </para>
        /// </remarks>
        public List<ReferenceType>? exposureVariant
        {
            get => _exposurevariant;
            set
            {
                _exposurevariant = value;
                OnPropertyChanged(nameof(exposureVariant));
            }
        }
        ...
        private List<ReferenceType>? _outcome;
        ...
        /// </para>
        /// </remarks>
        public List<ReferenceType>? outcome
        {
            get => _outcome;
            set
            {
