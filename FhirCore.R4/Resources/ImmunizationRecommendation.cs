...
{
    /// <summary>
    /// FHIR R4 ImmunizationRecommendation 資源
    /// 
    /// <para>
    ...
    /// <remarks>
    /// <para>
    /// R4 版本的 ImmunizationRecommendation 資源具有以下特點：
    /// - 增強的資料結構
    /// - 改進的驗證規則
    /// - 更好的互操作性
    /// </para>
    /// </remarks>
    public class ImmunizationRecommendation : ResourceBase<R4Version>
    {
        ...
        private List<BackboneElement>? _recommendation;
        ...
        /// </para>
        /// </remarks>
        public List<BackboneElement>? recommendation
        {
            get => _recommendation;
            set
            {
