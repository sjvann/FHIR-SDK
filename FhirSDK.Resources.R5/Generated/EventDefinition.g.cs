...
namespace FhirSDK.Resources.R5
{
    ...
    public partial class EventDefinition : ResourceBase
    {
        ...
        public EventDefinition(string json) { SetRawFrom(JsonNode.Parse(json)); }
        public EventDefinition(JsonNode? source) { SetRawFrom(source); }
        ...
        private List<TriggerDefinition> _trigger = new();
        [JsonPropertyName("trigger")]
        public List<TriggerDefinition> Trigger { get => _trigger; set { _trigger = value; OnPropertyChangedByClr(nameof(Trigger), value); } }
