...
public class MoneyQuantity : Element
{
    ...
    public override IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        // TODO: Implement FHIRPath expression evaluation
        // if (!EvaluateFHIRPath("(code.exists() or value.empty()) and (system.empty() or system = 'urn:iso:std:iso:4217')"))
        // {
        //     yield return new ValidationResult("There SHALL be a code if there is a value and it SHALL be an expression of currency.  If system is present, it SHALL be ISO 4217 (system = "urn:iso:std:iso:4217" - currency).", new[] { nameof(Quantity) });
        // }
        // Constraint: qty-3
