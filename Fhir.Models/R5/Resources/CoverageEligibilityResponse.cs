...
public class CoverageEligibilityResponse : DomainResource
{
    ...
    /// </summary>
    [FhirElement("serviceddateUnknown", Order = 23)]
    [Cardinality(0, 1)]
    ...
    /// </summary>
    [FhirElement("servicedPeriod", Order = 24)]
    [Cardinality(0, 1)]
    ...
    /// </summary>
    [FhirElement("requestor", Order = 26)]
    [Cardinality(0, 1)]
    ...
    /// </summary>
    [FhirElement("request", Order = 27)]
    [Cardinality(1, 1)]
    [Required]
    [JsonPropertyName("request")]
    public Reference<CoverageEligibilityRequest> Request { get; set; }

    /// <summary>
    /// The outcome of the request processing.
    /// </summary>
    [FhirElement("outcome", Order = 28)]
    [Cardinality(1, 1)]
    [Required]
    ...
    /// </summary>
    [FhirElement("disposition", Order = 29)]
    [Cardinality(0, 1)]
    ...
    /// </summary>
    [FhirElement("insurance", Order = 31)]
    [Cardinality(0, int.MaxValue)]
    [JsonPropertyName("insurance")]
    public List<BackboneElement>? Insurance { get; set; }

    /// <summary>
    /// A reference from the Insurer to which these services pertain to be used on further communication and
    /// as proof that the request occurred.
    /// </summary>
    ...
    public override IEnumerable<ValidationResult> Validate(ValidationContext validationContext)
    {
        ...
        // Validate CoverageEligibilityResponse cardinality
        var coverageeligibilityresponseCount = CoverageEligibilityResponse?.Count ?? 0;
        if (coverageeligibilityresponseCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse' cardinality must be 0..*", new[] { nameof(CoverageEligibilityResponse) });
        }
        // Validate Contained cardinality
        var containedCount = Contained?.Count ?? 0;
        if (containedCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.contained' cardinality must be 0..*", new[] { nameof(Contained) });
        }
        // Validate Extension cardinality
        var extensionCount = Extension?.Count ?? 0;
        if (extensionCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.extension' cardinality must be 0..*", new[] { nameof(Extension) });
        }
        // Validate ModifierExtension cardinality
        var modifierextensionCount = ModifierExtension?.Count ?? 0;
        if (modifierextensionCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.modifierExtension' cardinality must be 0..*", new[] { nameof(ModifierExtension) });
        }
        // Validate Identifier cardinality
        var identifierCount = Identifier?.Count ?? 0;
        if (identifierCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.identifier' cardinality must be 0..*", new[] { nameof(Identifier) });
        }
        if (Status == null)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.status' cardinality must be 1..1", new[] { nameof(Status) });
        }
        // Validate Purpose cardinality
        var purposeCount = Purpose?.Count ?? 0;
        if (purposeCount < 1)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.purpose' cardinality must be 1..*", new[] { nameof(Purpose) });
        }
        if (Patient == null)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.patient' cardinality must be 1..1", new[] { nameof(Patient) });
        }
        // Validate Event cardinality
        var eventCount = Event?.Count ?? 0;
        if (eventCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.event' cardinality must be 0..*", new[] { nameof(Event) });
        }
        // Validate Extension cardinality
        var extensionCount = Extension?.Count ?? 0;
        if (extensionCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.event.extension' cardinality must be 0..*", new[] { nameof(Extension) });
        }
        // Validate ModifierExtension cardinality
        var modifierextensionCount = ModifierExtension?.Count ?? 0;
        if (modifierextensionCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.event.modifierExtension' cardinality must be 0..*", new[] { nameof(ModifierExtension) });
        }
        if (Type == null)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.event.type' cardinality must be 1..1", new[] { nameof(Type) });
        }
        if (When == null)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.event.when[x]' cardinality must be 1..1", new[] { nameof(When) });
        }
        if (Created == null)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.created' cardinality must be 1..1", new[] { nameof(Created) });
        }
        if (Request == null)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.request' cardinality must be 1..1", new[] { nameof(Request) });
        }
        if (Outcome == null)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.outcome' cardinality must be 1..1", new[] { nameof(Outcome) });
        }
        if (Insurer == null)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurer' cardinality must be 1..1", new[] { nameof(Insurer) });
        }
        // Validate Insurance cardinality
        var insuranceCount = Insurance?.Count ?? 0;
        if (insuranceCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurance' cardinality must be 0..*", new[] { nameof(Insurance) });
        }
        // Validate Extension cardinality
        var extensionCount = Extension?.Count ?? 0;
        if (extensionCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurance.extension' cardinality must be 0..*", new[] { nameof(Extension) });
        }
        // Validate ModifierExtension cardinality
        var modifierextensionCount = ModifierExtension?.Count ?? 0;
        if (modifierextensionCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurance.modifierExtension' cardinality must be 0..*", new[] { nameof(ModifierExtension) });
        }
        if (Coverage == null)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurance.coverage' cardinality must be 1..1", new[] { nameof(Coverage) });
        }
        // Validate Item cardinality
        var itemCount = Item?.Count ?? 0;
        if (itemCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurance.item' cardinality must be 0..*", new[] { nameof(Item) });
        }
        // Validate Extension cardinality
        var extensionCount = Extension?.Count ?? 0;
        if (extensionCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurance.item.extension' cardinality must be 0..*", new[] { nameof(Extension) });
        }
        // Validate ModifierExtension cardinality
        var modifierextensionCount = ModifierExtension?.Count ?? 0;
        if (modifierextensionCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurance.item.modifierExtension' cardinality must be 0..*", new[] { nameof(ModifierExtension) });
        }
        // Validate Modifier cardinality
        var modifierCount = Modifier?.Count ?? 0;
        if (modifierCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurance.item.modifier' cardinality must be 0..*", new[] { nameof(Modifier) });
        }
        // Validate Benefit cardinality
        var benefitCount = Benefit?.Count ?? 0;
        if (benefitCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurance.item.benefit' cardinality must be 0..*", new[] { nameof(Benefit) });
        }
        // Validate Extension cardinality
        var extensionCount = Extension?.Count ?? 0;
        if (extensionCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurance.item.benefit.extension' cardinality must be 0..*", new[] { nameof(Extension) });
        }
        // Validate ModifierExtension cardinality
        var modifierextensionCount = ModifierExtension?.Count ?? 0;
        if (modifierextensionCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurance.item.benefit.modifierExtension' cardinality must be 0..*", new[] { nameof(ModifierExtension) });
        }
        if (Type == null)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurance.item.benefit.type' cardinality must be 1..1", new[] { nameof(Type) });
        }
        // Validate AuthorizationSupporting cardinality
        var authorizationsupportingCount = AuthorizationSupporting?.Count ?? 0;
        if (authorizationsupportingCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.insurance.item.authorizationSupporting' cardinality must be 0..*", new[] { nameof(AuthorizationSupporting) });
        }
        // Validate Error cardinality
        var errorCount = Error?.Count ?? 0;
        if (errorCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.error' cardinality must be 0..*", new[] { nameof(Error) });
        }
        // Validate Extension cardinality
        var extensionCount = Extension?.Count ?? 0;
        if (extensionCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.error.extension' cardinality must be 0..*", new[] { nameof(Extension) });
        }
        // Validate ModifierExtension cardinality
        var modifierextensionCount = ModifierExtension?.Count ?? 0;
        if (modifierextensionCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.error.modifierExtension' cardinality must be 0..*", new[] { nameof(ModifierExtension) });
        }
        if (Code == null)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.error.code' cardinality must be 1..1", new[] { nameof(Code) });
        }
        // Validate Expression cardinality
        var expressionCount = Expression?.Count ?? 0;
        if (expressionCount < 0)
        {
            yield return new ValidationResult("Element 'CoverageEligibilityResponse.error.expression' cardinality must be 0..*", new[] { nameof(Expression) });
        }
        ...
        if (Purpose != null)
        {
            // TODO: Implement ValueSet validation for http://hl7.org/fhir/ValueSet/eligibilityresponse-purpose|5.0.0
            // This requires a terminology service or local ValueSet cache
        }
        // Validate Outcome ValueSet binding
        if (Outcome != null)
        {
            // TODO: Implement ValueSet validation for http://hl7.org/fhir/ValueSet/eligibility-outcome|5.0.0
            // This requires a terminology service or local ValueSet cache
        }
        ...
        // {
        //     yield return new ValidationResult("If the resource is contained in another resource, it SHALL NOT contain nested Resources", new[] { nameof(CoverageEligibilityResponse) });
        // }
        // Constraint: dom-3
        ...
        // {
        //     yield return new ValidationResult("If the resource is contained in another resource, it SHALL be referred to from elsewhere in the resource or SHALL refer to the containing resource", new[] { nameof(CoverageEligibilityResponse) });
        // }
        // Constraint: dom-4
        ...
        // {
        //     yield return new ValidationResult("If a resource is contained in another resource, it SHALL NOT have a meta.versionId or a meta.lastUpdated", new[] { nameof(CoverageEligibilityResponse) });
        // }
        // Constraint: dom-5
        ...
        // {
        //     yield return new ValidationResult("If a resource is contained in another resource, it SHALL NOT have a security label", new[] { nameof(CoverageEligibilityResponse) });
        // }
        // Constraint: dom-6
        ...
        // {
        //     yield return new ValidationResult("A resource should have narrative for robust management", new[] { nameof(CoverageEligibilityResponse) });
        // }
        // Constraint: ele-1
        ...
        // if (!EvaluateFHIRPath("hasValue() or (children().count() > id.count())"))
        // {
        //     yield return new ValidationResult("All FHIR elements must have a @value or children", new[] { nameof(Inforce) });
        // }
        // Constraint: ele-1
        // Expression: hasValue() or (children().count() > id.count())
        // TODO: Implement FHIRPath expression evaluation
        ...
        // TODO: Implement FHIRPath expression evaluation
        // if (!EvaluateFHIRPath("category.exists() xor productOrService.exists()"))
        // {
        //     yield return new ValidationResult("SHALL contain a category or a billcode but not both.", new[] { nameof(Item) });
        // }
        // Constraint: ele-1
        // Expression: hasValue() or (children().count() > id.count())
        // TODO: Implement FHIRPath expression evaluation
        ...
        // if (!EvaluateFHIRPath("hasValue() or (children().count() > id.count())"))
        // {
        //     yield return new ValidationResult("All FHIR elements must have a @value or children", new[] { nameof(AuthorizationRequired) });
        // }
        // Constraint: ele-1
        // Expression: hasValue() or (children().count() > id.count())
        // TODO: Implement FHIRPath expression evaluation
        // if (!EvaluateFHIRPath("hasValue() or (children().count() > id.count())"))
        // {
        //     yield return new ValidationResult("All FHIR elements must have a @value or children", new[] { nameof(AuthorizationSupporting) });
        // }
        // Constraint: ele-1
        // Expression: hasValue() or (children().count() > id.count())
        // TODO: Implement FHIRPath expression evaluation
        // if (!EvaluateFHIRPath("hasValue() or (children().count() > id.count())"))
        // {
        //     yield return new ValidationResult("All FHIR elements must have a @value or children", new[] { nameof(AuthorizationUrl) });
        // }
        // Constraint: ele-1
        // Expression: hasValue() or (children().count() > id.count())
        // TODO: Implement FHIRPath expression evaluation
