...
{
    public class PlanDefinition : DomainResource<PlanDefinition>
    {
        #region Property
...
[Element("goal", typeof(Goal), false, true, false, true)]
...
[Element("action", typeof(ResourceTypeServices.R5.PlanDefinitionSub.Action), false, true, false, true)]
public IEnumerable<ResourceTypeServices.R5.PlanDefinitionSub.Action> Action {get; set;}
...
public ChoiceBased AsNeeded {get; set;}
        ...
        #endregion
        #region From Parent
        protected override string _TypeName => "PlanDefinition";
        #endregion
