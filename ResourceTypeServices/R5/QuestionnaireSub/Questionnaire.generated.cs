...
{
    public class Questionnaire : DomainResource<Questionnaire>
    {
        #region Property
...
[Element("subjectType", typeof(FhirCode), true, true, false, false)]
public IEnumerable<FhirCode> SubjectType {get; set;}
