...
{
    public class GraphDefinition : DomainResource<GraphDefinition>
    {
        #region Property
...
[Element("start", typeof(FhirId), true, false, false, false)]
public FhirId Start {get; set;}
[Element("node", typeof(Node), false, true, false, true)]
...
public IEnumerable<Link> Link {get; set;}
        ...
        #endregion
        #region From Parent
        protected override string _TypeName => "GraphDefinition";
        #endregion
