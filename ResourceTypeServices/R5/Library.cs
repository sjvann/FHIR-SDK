...
{
    public class Library : ResourceType<Library>
	{
...
OnPropertyChanged("content", value);
		...
		public  Library(JsonNode? source) : base(source) { }
		#endregion
	}
		    ...
		    public class LibraryVersionAlgorithmChoice : ChoiceType 
    {
        ...
        public LibraryVersionAlgorithmChoice(JsonObject value) : base("versionAlgorithm", value, _supportType)
        {
        }
        public LibraryVersionAlgorithmChoice(IComplexType? value) : base("versionAlgorithm", value)
        {
        }
        public LibraryVersionAlgorithmChoice(IPrimitiveType? value) : base("versionAlgorithm", value) { }
	    ...
	    public class LibrarySubjectChoice : ChoiceType 
    {
        ...
        public LibrarySubjectChoice(JsonObject value) : base("subject", value, _supportType)
        {
        }
        public LibrarySubjectChoice(IComplexType? value) : base("subject", value)
        {
        }
        public LibrarySubjectChoice(IPrimitiveType? value) : base("subject", value) { }
