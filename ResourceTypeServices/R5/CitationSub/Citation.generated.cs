...
{
    public class Citation : DomainResource<Citation>
    {
        #region Property
...
[Element("citedArtifact", typeof(CitedArtifact), false, false, false, true)]
public CitedArtifact CitedArtifact {get; set;}
        ...
        #endregion
        #region From Parent
        protected override string _TypeName => "Citation";
        #endregion
