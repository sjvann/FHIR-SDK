...
{
    public class StructureMap : DomainResource<StructureMap>
    {
        #region Property
...
[Element("structure", typeof(Structure), false, true, false, true)]
public IEnumerable<Structure> Structure {get; set;}
[Element("import", typeof(FhirCanonical), true, true, false, false)]
public IEnumerable<FhirCanonical> Import {get; set;}
[Element("const", typeof(Const), false, true, false, true)]
public IEnumerable<Const> Const {get; set;}
...
public IEnumerable<Group> Group {get; set;}
        ...
        #endregion
        #region From Parent
        protected override string _TypeName => "StructureMap";
        #endregion
