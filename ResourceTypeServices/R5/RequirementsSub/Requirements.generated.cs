...
{
    public class Requirements : DomainResource<Requirements>
    {
        #region Property
...
[Element("actor", typeof(FhirCanonical), true, true, false, false)]
public IEnumerable<FhirCanonical> Actor {get; set;}
[Element("statement", typeof(Statement), false, true, false, true)]
public IEnumerable<Statement> Statement {get; set;}
        ...
        #endregion
        #region From Parent
        protected override string _TypeName => "Requirements";
        #endregion
