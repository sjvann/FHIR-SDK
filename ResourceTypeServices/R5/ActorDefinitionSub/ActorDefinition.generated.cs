...
namespace ResourceTypeServices.R5.ActorDefinitionSub
{
    public class ActorDefinition : DomainResource<ActorDefinition>
    {
        #region Property
...
public IEnumerable<FhirCanonical> DerivedFrom {get; set;}
        ...
        #endregion
        #region From Parent
        protected override string _TypeName => "ActorDefinition";
        #endregion
