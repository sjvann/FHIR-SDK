...
{
    public class ConceptMap : DomainResource<ConceptMap>
    {
        #region Property
...
[Element("additionalAttribute", typeof(AdditionalAttribute), false, true, false, true)]
public IEnumerable<AdditionalAttribute> AdditionalAttribute {get; set;}
[Element("sourceScope", typeof(ChoiceBased), false, false, true, false)]
public ChoiceBased SourceScope {get; set;}
[Element("targetScope", typeof(ChoiceBased), false, false, true, false)]
public ChoiceBased TargetScope {get; set;}
...
public IEnumerable<Group> Group {get; set;}
        ...
        #endregion
        #region From Parent
        protected override string _TypeName => "ConceptMap";
        #endregion
