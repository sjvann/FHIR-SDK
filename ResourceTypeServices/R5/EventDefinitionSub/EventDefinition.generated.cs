...
namespace ResourceTypeServices.R5.EventDefinitionSub
{
    public class EventDefinition : DomainResource<EventDefinition>
    {
        #region Property
...
public IEnumerable<TriggerDefinition> Trigger {get; set;}
        ...
        #endregion
        #region From Parent
        protected override string _TypeName => "EventDefinition";
        #endregion
