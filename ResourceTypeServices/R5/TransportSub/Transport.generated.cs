...
{
    public class Transport : DomainResource<Transport>
    {
        #region Property
...
[Element("completionTime", typeof(FhirDateTime), true, false, false, false)]
...
[Element("requestedLocation", typeof(Reference), false, false, false, false)]
public Reference RequestedLocation {get; set;}
[Element("currentLocation", typeof(Reference), false, false, false, false)]
public Reference CurrentLocation {get; set;}
[Element("reason", typeof(CodeableReference), false, false, false, false)]
public CodeableReference Reason {get; set;}
[Element("history", typeof(Reference), false, false, false, false)]
public Reference History {get; set;}
        ...
        #endregion
        #region From Parent
        protected override string _TypeName => "Transport";
        #endregion
