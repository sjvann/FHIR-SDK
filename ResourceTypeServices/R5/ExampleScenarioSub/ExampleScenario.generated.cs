...
{
    public class ExampleScenario : DomainResource<ExampleScenario>
    {
        #region Property
...
[Element("process", typeof(Process), false, true, false, true)]
public IEnumerable<Process> Process {get; set;}
        ...
        #endregion
        #region From Parent
        protected override string _TypeName => "ExampleScenario";
        #endregion
