...
{
    public class TestPlan : DomainResource<TestPlan>
    {
        #region Property
...
[Element("testTools", typeof(FhirMarkdown), true, false, false, false)]
...
[Element("exitCriteria", typeof(FhirMarkdown), true, false, false, false)]
public FhirMarkdown ExitCriteria {get; set;}
[Element("testCase", typeof(TestCase), false, true, false, true)]
public IEnumerable<TestCase> TestCase {get; set;}
        ...
        #endregion
        #region From Parent
        protected override string _TypeName => "TestPlan";
        #endregion
